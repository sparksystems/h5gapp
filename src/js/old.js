...
var colors = ["#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#eee", "#ddd", "#ddd", "#ddd", "#ddd", "#ddd", "#ccc", "#ccc", "#ccc", "#999", "#666", "#333", "#000"];
...
function tongxin() {
  var x = bw / 2,
    y = bh / 2,
    w = Math.sqrt(bw * bw + bh * bh) / (clen * 2 - 1);
  for (var i = 0; i < clen - 1; i++) {
    ctx.beginPath();
